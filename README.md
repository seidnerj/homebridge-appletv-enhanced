...
![PyPI pyversions](https://img.shields.io/badge/Python-3.10%20%7C%203.11%20%7C%203.12%20%7C%203.13-blue)
...
```json
{
    ...
    "fixInvalidCharacteristics": false,
...
| `disableCharacteristics`     | Disables custom characteristics (album, artist, contentIdentifier, episodeNumber, genre, iTunesStoreIdentifier, outputDevices, position, repeat, seasonNumber, seriesName, shuffle, title, totalTime)                                                                                                                                                                                                                                                                                          | `boolean`       |                                                                                                                                                                                                                                                                              | `false`                                                     |
| `disableInputs`              | Disables inputs (AvadaKedavra, Home, AirPlay, apps). Useful for decluttering the accessory page in the Home app.                                                                                                                                                                                                                                                                                                                                                                               | `boolean`       |                                                                                                                                                                                                                                                                              | `false`                                                     |
...
| `fixInvalidCharacteristics`  | Apple TVs and their apps sometimes report names or values that HomeKit rejects, which shows up as a HAP-NodeJS warning in the log. Set this to rewrite them into something HomeKit accepts: names are stripped down to letters, numbers, spaces, apostrophes and common punctuation and are made to start and end with a letter or a number, numbers that fall outside of the range of their characteristic are pulled back into it.                                                           | `boolean`       |                                                                                                                                                                                                                                                                              | `false`                                                     |
